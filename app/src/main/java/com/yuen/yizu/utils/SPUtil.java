...
public class SPUtil {
    ...
    public static <T> boolean saveObjectToShare(String key, T t) {
        return saveObjectToShare(ApplicationEx.getInstance(), PreferenceName, key, t);
    }
    ...
    public static <T> T getObjectFromShare(String key) {
        return getObjectFromShare(ApplicationEx.getInstance(), PreferenceName, key);
    }
    ...
    public static void saveString(String key, String value) {
        SharedPreferences sp = ApplicationEx.getInstance().getSharedPreferences(PreferenceName,
